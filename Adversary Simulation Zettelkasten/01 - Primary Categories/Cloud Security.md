...
Security assessment and exploitation of cloud infrastructure across AWS, Azure, GCP, and other cloud platforms. Includes cloud-native vulnerabilities, misconfigurations, IAM exploitation, and serverless security.
