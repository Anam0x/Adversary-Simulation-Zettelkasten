...
Cryptographic algorithms, protocols, and implementation vulnerabilities relevant to security assessments. Includes encryption/decryption techniques, hash functions, PKI, and cryptographic attacks.
