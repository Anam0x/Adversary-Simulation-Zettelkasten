...
Programming languages, frameworks, and development practices relevant to security tooling and exploit development. Covers scripting (Python, PowerShell, Bash), compiled languages (C, C++, Go), and secure coding practices.
