...
Development and optimization of detection rules, signatures, and behavioral analytics for identifying malicious activity. Covers SIEM queries, EDR telemetry, threat hunting methodologies, and alert tuning.
