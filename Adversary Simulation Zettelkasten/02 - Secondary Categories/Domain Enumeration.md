...
Active Directory (AD) reconnaissance techniques for mapping domain structure, users, groups, trusts, and security policies. Covers LDAP queries, BloodHound analysis, user enumeration, permission mapping, and identifying attack paths.
