...
Enumeration, exploitation, and post-exploitation techniques targeting Windows Active Directory (AD) environments. Covers domain reconnaissance, privilege escalation, credential theft, persistence mechanisms, and lateral movement within enterprise domains.
