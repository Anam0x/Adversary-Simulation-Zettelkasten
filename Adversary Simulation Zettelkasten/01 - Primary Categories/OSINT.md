...
Open-source intelligence gathering techniques for reconnaissance and information collection from publicly available sources. Includes passive reconnaissance, social media analysis, data aggregation, and OSINT automation tools.
